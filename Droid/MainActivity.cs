...
namespace WeekCalendarViewComponent.Droid
{
    [Activity(Label = "WeekCalendarViewComponent", MainLauncher = true, Icon = "@mipmap/icon", Theme = "@style/MyTheme")]
    public class MainActivity : AppCompatActivity , WeekView.IEventClickListener, WeekView.IEventLongPressListener,
    MonthLoader.IMonthChangeListener, IDisposable
    {
        ...
        class MyDateTimeInterpreter : Java.Lang.Object, IDateTimeInterpreter
        {
            ...
            //public string InterpretTime(int p0)
            //{
