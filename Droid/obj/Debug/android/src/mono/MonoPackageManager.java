...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "WeekCalendarViewComponent.Droid.dll" comes first in this list. */
		"WeekCalendarViewComponent.Droid.dll",
		"BindingsWeekView.dll",
		"WeekCalendarViewComponent.dll",
